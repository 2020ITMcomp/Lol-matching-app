...
public class ItemMessageReceivedBindingImpl extends ItemMessageReceivedBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.image_message_profile, 1);
        sViewsWithIds.put(R.id.text_message_name, 2);
        sViewsWithIds.put(R.id.text_message_body, 3);
        sViewsWithIds.put(R.id.text_message_time, 4);
    }
    // views
    @NonNull
